...
const Projects = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <button
        onClick={() => navigate("/")}
        className="fixed top-12 left-12 z-50 flex items-center gap-2 font-display text-sm tracking-[0.15em] uppercase text-foreground hover:opacity-70 transition-opacity"
      >
        <ArrowLeft size={18} />
        Back
      </button>
      ...
      <div className="pt-28 pb-12 text-center">
        <h1 className="font-display text-[clamp(28px,4vw,48px)] font-semibold tracking-tight text-foreground">
          Projects
        </h1>
...
const SocialFooter = () => {
  const socials = [
    ...
    { label: "Facebook", href: "https://www.facebook.com/share/1SXTmx3Zcj/", icon: <FacebookIcon /> },
    { label: "TikTok", href: "https://linktr.ee/3h0ll", icon: <TikTokIcon /> },
    { label: "Letterboxd", href: "https://boxd.it/7RQST", icon: <LetterboxdIcon /> },
  ];

  return (
    <div className="flex justify-center gap-6 pb-12 flex-wrap px-6">
      {socials.map((s) => (
        <a
          key={s.label}
          href={s.href}
...
const FacebookIcon = () => (
  <svg width="24" height="24" viewBox="0 0 320 512" fill="currentColor">
...
const LetterboxdIcon = () => (
  <svg width="24" height="24" viewBox="0 0 500 500" fill="currentColor">
    <circle cx="250" cy="250" r="230" fill="none" stroke="currentColor" strokeWidth="40" />
    <circle cx="175" cy="250" r="60" />
    <circle cx="325" cy="250" r="60" />
  </svg>
);
